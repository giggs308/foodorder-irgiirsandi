...
function getOrderItems($conn, $order_id) {
    $query = "SELECT m.nama_menu, m.harga, d.jumlah, (m.harga * d.jumlah) as subtotal, m.deskripsi 
...
<head>
    ...
    <title>Pesanan - Admin FoodOrder</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/boxicons@2.1.1/css/boxicons.min.css" rel="stylesheet">
    <link href="../assets/css/admin.css" rel="stylesheet">
    <style>
        .modal .table td, .modal .table th { vertical-align: middle; }
    </style>
</head>
<body>
    <div class="d-flex">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $modals = ''; while ($order = mysqli_fetch_assoc($orders)): ?>
                                        <tr>
                                        ...
                                        <?php ob_start(); ?>
                                        <div class="modal" id="orderDetail<?= $order['id_pesanan'] ?>" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
